...
const Subscription = () => {
    return (
        <div className="text-white mt-52 mb-36">
            <div>
            <h1 className="md:text-5xl text-center">We work in variety of industries <br /> and have strong experience <br /> serving  
             <a className="ml-2" href="#">E-commerce</a>
            , <a href="#">Healthcare</a>, <br /> <a href="#">BlockChain</a> and <a href="#"> Sass</a></h1>
            </div>
